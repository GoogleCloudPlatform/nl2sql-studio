...
if __name__ == "__main__":
    ...
    eval_model = GenerativeModel("gemini-2.5-flash")

    INPUT_FILE_PATH = "./results/results-910_records/merged_stage2_results_mt.json"
    OUTPUT_FILE_PATH = "./results/results-910_records/merged_stage3_eval_results_flash.json"
    ...
    for row in stage2_data:
        ...
        --- Query ---
        SQL: {row.get('sql', '')}
        Result Summary: {row.get('result_summary', '')}
        """
